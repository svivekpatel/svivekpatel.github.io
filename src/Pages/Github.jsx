...
const Github = () => {
  return (
    <Box  margin={"auto"} gap={"5px"} pb={{ base: "20px", md: "30px", lg: "100px" }}>
        <Box fontSize={{ base: "30px", md: "40px", lg: "50px" }} pb={"20px"} fontWeight={"bold"} mb={"30px"} color={"gray.600"}><u>Github</u></Box>



<Flex align={"center"} w={{ base: '100%', md: '80%', lg: '66%' }} h={ '250px' } margin={"auto"} bg={"gray.600"} boxShadow="rgba(0, 0, 0, 0.16) 0px 1px 4px, rgb(51, 51, 51) 0px 0px 0px 3px" marginBottom={"40px"} border={"10px solid #98FB98"} justifyContent={"center"} p={"20px"}>
...
<Flex align={"center"} w={{ base: '100%', md: '80%', lg: '66%' }} h={ '250px' } margin={"auto"} bg={"gray.600"} color={"white"} boxShadow="rgba(0, 0, 0, 0.16) 0px 1px 4px, rgb(51, 51, 51) 0px 0px 0px 3px" marginBottom={"40px"} border={"10px solid #98FB98"}  justifyContent={"center"} p={"20px"}>
