...
<Flex align={"center"} w={{ base: '100%', md: '80%', lg: '66%' }} h={ '250px' } margin={"auto"} bg={"gray.600"} color={"white"} boxShadow="rgba(0, 0, 0, 0.16) 0px 1px 4px, rgb(51, 51, 51) 0px 0px 0px 3px" marginBottom={"40px"} border={"10px solid gray"}  justifyContent={"center"} p={"20px"}>
