...
function Skills() {
  return <Box id="skills" pb={{ base: "20px", md: "30px", lg: "100px" }} >
    <Box fontSize={"50px"} fontWeight={"bold"} mb={"30px"}><u>Skills</u></Box>
    <Box p={4} w={"90%"} margin={"auto"} mb={{ base: "20px", md: "30px", lg: "100px" }}>
      <SimpleGrid columns={{ base: 2, md: 4, }} spacing={"60px"}>
        <GridItem className="skills-card" backgroundColor={"lightgray"} _hover={{ bgColor: "white" }} margin={"auto"} justifyContent={"center"} alignItems={"center"} boxShadow={"rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 1px 3px 1px"} border={"4px solid #98FB98"} p={"30px"} borderRadius={"8px"}>
          <Feature
            icon={<Image className="skills-card-img" as={AiFillHtml5} color={"orange.500"} w={10} h={10} />}
          />
          <Text className="skills-card-name" fontWeight={"medium"}>HTML</Text>
        </GridItem>
        <GridItem className="skills-card" backgroundColor={"lightgray"} _hover={{ bgColor: "white" }} margin={"auto"} justifyContent={"center"} alignItems={"center"} boxShadow={"rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 1px 3px 1px"} border={"2px solid #98FB98"} p={"30px"} borderRadius={"8px"}>
          <Feature
            icon={<Icon className="skills-card-img" as={DiCss3} color={"blue.500"} w={10} h={10} />}
          />
          <Text className="skills-card-name" fontWeight={"medium"}>CSS</Text>
        </GridItem>
        <GridItem className="skills-card" backgroundColor={"lightgray"} _hover={{ bgColor: "white" }} margin={"auto"} justifyContent={"center"} alignItems={"center"} boxShadow={"rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 1px 3px 1px"} border={"4px solid #98FB98"} p={"30px"} borderRadius={"8px"}>
          <Feature
            icon={<Icon className="skills-card-img" as={SiJavascript} color={"yellow.500"} bg={"black"} w={8} h={8} />}
          />
          <Text className="skills-card-name" fontWeight={"medium"}>JavaScript</Text>
        </GridItem>
        <GridItem className="skills-card" backgroundColor={"lightgray"} _hover={{ bgColor: "white" }} margin={"auto"} justifyContent={"center"} alignItems={"center"} boxShadow={"rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 1px 3px 1px"} border={"2px solid #98FB98"} p={"30px"} borderRadius={"8px"}>
          <Feature
            icon={<Icon className="skills-card-img" as={DiReact} color={"blue.500"} w={10} h={10} />}
          />
          <Text className="skills-card-name" fontWeight={"medium"}>React</Text>
        </GridItem>
        <GridItem className="skills-card" backgroundColor={"lightgray"} _hover={{ bgColor: "white" }} margin={"auto"} justifyContent={"center"} alignItems={"center"} boxShadow={"rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 1px 3px 1px"} border={"2px solid #98FB98"} p={"30px"} borderRadius={"8px"}>
          <Feature
            icon={<Icon className="skills-card-img" as={SiRedux} color={"purple.500"} w={8} h={8} />}
          />
        ...
        <GridItem className="skills-card" backgroundColor={"lightgray"} _hover={{ bgColor: "white" }} margin={"auto"} justifyContent={"center"} alignItems={"center"} boxShadow={"rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 1px 3px 1px"} border={"4px solid #98FB98"} p={"30px"} borderRadius={"8px"}>
          <Feature
            icon={<Icon className="skills-card-img" as={SiTypescript} color={"blue.500"} w={8} h={8} />}
          />
          <Text className="skills-card-name" fontWeight={"medium"}>TypeScript</Text>
        </GridItem>
        <GridItem className="skills-card" backgroundColor={"lightgray"} _hover={{ bgColor: "white" }} margin={"auto"} justifyContent={"center"} alignItems={"center"} boxShadow={"rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 1px 3px 1px"} border={"2px solid #98FB98"} p={"30px"} borderRadius={"8px"}>
          <Feature
            icon={<Icon className="skills-card-img" as={SiExpress} color={"black"} w={9} h={9} />}
          />
          <Text className="skills-card-name" fontWeight={"medium"}>Express JS</Text>
        </GridItem>
        <GridItem className="skills-card" backgroundColor={"lightgray"} _hover={{ bgColor: "white" }} margin={"auto"} justifyContent={"center"} alignItems={"center"} boxShadow={"rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 1px 3px 1px"} border={"4px solid #98FB98"} p={"30px"} borderRadius={"8px"}>
          <Feature
            icon={<Icon className="skills-card-img" as={TbBrandNextjs} color={"black"} w={10} h={10} />}
          />
          <Text className="skills-card-name" fontWeight={"medium"}>Next JS</Text>
        </GridItem>
        <GridItem className="skills-card" backgroundColor={"lightgray"} _hover={{ bgColor: "white" }} margin={"auto"} justifyContent={"center"} alignItems={"center"} boxShadow={"rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 1px 3px 1px"} border={"2px solid #98FB98"} p={"30px"} borderRadius={"8px"}>
          <Feature
            icon={<Icon className="skills-card-img" as={FaGithub} color={"black"} w={9} h={9} />}
          />
    ...
    <Box fontSize={"50px"} fontWeight={"bold"} mb={"30px"}><u>Tools</u></Box>
    <Box p={4} w={"90%"} margin={"auto"}>
      <SimpleGrid columns={{ base: 2, md: 4, }} spacing={"60px"}>

        <GridItem className="skills-card" backgroundColor={"lightgray"} _hover={{ bgColor: "white" }} margin={"auto"} justifyContent={"center"} alignItems={"center"} boxShadow={"rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 1px 3px 1px"} border={"1px solid #98FB98"} p={"30px"} borderRadius={"8px"}>
